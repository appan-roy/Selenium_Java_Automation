...
public class ExcelWriter {
	...
	public void writeExcel(String filePath, String fileName, String sheetName, String[] dataToWrite)
		...
		// Check condition if the file is xls file
			...
			wrkbk = new HSSFWorkbook(inputStream);
	...
	// Main function is calling writeExcel function to write data into excel file
	...
	public static void main(String... strings) throws IOException {
		...
		String[] valueToWrite = { "Amrita", "Pandey", "Female", "10", "26/11/2010", "Manual Tester", "", "Africa", "Inactive" };
		...
		objExcelFile.writeExcel(System.getProperty("user.dir") + "/Data Files/", "DSTeamData.xlsx", "Members", valueToWrite);
